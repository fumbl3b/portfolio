    ...
    return (
      ...
      <div className="App">
        ...
        <Section id='contact'>
          ...
          <ul>
            <li><a href='mailto: harryewinkler@gmail.com'>Send Email</a></li>
            <li><a href='https://github.com/fumbl3b/'>GitHub</a></li>
            <li><a href='https://www.linkedin.com/in/harry-winkler/'>LinkedIn</a></li>
          </ul>
        </Section>
